        ...
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
                <Card
                    ...
                    description="Through a collaborative process, we will define your website's goals, target audience, and key functionalities. We will then discuss aspects such as site structure, navigation, and content requirements.">
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                <Card
                    ...
                    description="With the plan finalized, I'll fire up my lofi beats and get coding! From the initial wireframes to the finished product, you'll be kept in the loop throughout the development process.">
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card
                    ...
                    description="Get ready for the fun part! With your design locked in, I'll weave it into a fully-functioning website by coding everything from scratch. Buckle up, we're building something awesome!">
                    <CanvasRevealEffect
                        animationSpeed={3}
